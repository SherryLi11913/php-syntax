...
<html>
    <body>
        <?php
            ...
            $file_write = fopen("file_write.txt", "r");
            ...
            $file_write = fopen("file_write.txt", "w");
            ...
            $file_append = fopen("file_write.txt", "r");
